    ...
    <div class="flex flex-col md:flex-row justify-between items-start space-y-4 md:space-y-0">
      ...
      <div class="flex gap-2">
        <button @click="show(id)"
          class="px-3 py-1 text-sm text-gray-900 hover:text-gray-600 border border-gray-300 rounded-md transition-colors">
          Ver
        </button>
        ...
        <button @click="destroy(id)"
          class="px-3 py-1 text-sm text-gray-500 hover:text-red-800 border border-gray-300 rounded-md transition-colors">
          Excluir
        </button>
      </div>
    </div>
